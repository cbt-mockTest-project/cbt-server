...
let MockExamQuestionFeedbackResolver = class MockExamQuestionFeedbackResolver {
    ...
    async deleteMockExamQuestionFeedback(deleteMockExamQuestionFeedbackInput) {
        return this.mockExamQuestionFeedbackSerivce.deleteMockExamQuestionFeedback(deleteMockExamQuestionFeedbackInput);
    }
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [deleteMockExamQuestionFeedback_dto_1.DeleteMockExamQuestionFeedbackInput]),
    __metadata("design:returntype", Promise)
