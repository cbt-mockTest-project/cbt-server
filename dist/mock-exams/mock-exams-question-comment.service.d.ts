...
export declare class MockExamQuestionCommentSerivce {
    ...
    constructor(mockExamQuestionCommentLike: Repository<MockExamQuestionCommentLike>, mockExamQuestionComment: Repository<MockExamQuestionComment>, mockExamQuestion: Repository<MockExamQuestion>, users: Repository<User>);
