...
let PostLike = class PostLike extends core_entity_1.CoreEntity {
};
__decorate([
    (0, typeorm_1.ManyToOne)(() => post_entity_1.Post, (post) => post.like, {
        onDelete: 'CASCADE',
    }),
...
PostLike = __decorate([
    (0, graphql_1.InputType)('PostLikeInputType', { isAbstract: true }),
