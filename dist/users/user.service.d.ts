...
export declare class UserService {
    ...
    constructor(users: Repository<User>, verification: Repository<Verification>, feedback: Repository<Feedback>, mailService: MailService, jwtService: JwtService, telegramService: TelegramService, noticeService: NoticeService);
