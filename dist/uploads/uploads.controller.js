...
let UploadsController = class UploadsController {
    ...
    async uploadFile(uploadInput, file) {
        ...
        try {
            ...
            const objectName = `${(uploadInput.id + '_' || '') + Date.now() + '_' + file.originalname}`;
...
__decorate([
    ...
    __metadata("design:paramtypes", [uploads_dto_1.UploadInput, Object]),
