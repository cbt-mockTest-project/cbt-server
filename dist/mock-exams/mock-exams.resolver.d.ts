...
export declare class MockExamResolver {
    ...
    deleteMockExam(user: any, deleteMockExamInput: DeleteMockExamInput): Promise<DeleteMockExamOutput>;
    ...
    readMockExamTitlesByCateory(readMockExamTitlesByCateoryInput: ReadMockExamTitlesByCateoryInput, user: User): Promise<ReadMockExamTitlesByCateoryOutput>;
