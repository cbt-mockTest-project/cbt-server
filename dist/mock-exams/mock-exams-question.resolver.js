...
let MockExamQuestionResolver = class MockExamQuestionResolver {
    ...
    createMockExamQuestion(createMockExamQuestionInput) {
        return this.mockExamQuestionService.createMockExamQuestion(createMockExamQuestionInput);
    }
    editMockExamQuestion(editMockExamQuestionInput) {
        return this.mockExamQuestionService.editMockExamQuestion(editMockExamQuestionInput);
    }
    deleteMockExamQuestion(deleteMockExamQuestionInput) {
        return this.mockExamQuestionService.deleteMockExamQuestion(deleteMockExamQuestionInput);
    }
    ...
    async readMockExamQuestion(user, readMockExamQuestionInput) {
        return this.mockExamQuestionService.readMockExamQuestion(readMockExamQuestionInput, user.id);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [createMockExamQuestion_dto_1.CreateMockExamQuestionInput]),
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [editMockExamQuestion_dto_1.EditMockExamQuestionInput]),
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [deleteMockExamQuestion_dto_1.DeleteMockExamQuestionInput]),
    __metadata("design:returntype", Promise)
